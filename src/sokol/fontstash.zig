...
pub extern fn sfons_create([*c]const Desc) [*c]i32;
pub fn create(desc: Desc) *i32 {
    return sfons_create(&desc);
}
pub extern fn sfons_destroy([*c]i32) void;
pub fn destroy(ctx: *i32) void {
    sfons_destroy(ctx);
}
pub extern fn sfons_flush([*c]i32) void;
pub fn flush(ctx: *i32) void {
    sfons_flush(ctx);
}
